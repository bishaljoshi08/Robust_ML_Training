...
best_score = -1.0
checkpoint_path = "/scratch/bjoshi/robustness/pgd_version5_manual_lr.pt"
...
for epoch in range(1, EPOCHS + 1):
    ...
    # Manual LR schedule: decay by LR_GAMMA at each milestone
    if epoch in LR_MILESTONES:
        for pg in optimizer.param_groups:
            pg['lr'] *= LR_GAMMA
        print(f"  [LR] Epoch {epoch}: LR decayed to {optimizer.param_groups[0]['lr']:.6f}")
