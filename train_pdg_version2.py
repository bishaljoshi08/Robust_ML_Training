...
best_score = -1.0
checkpoint_path = "/scratch/bjoshi/robustness/pgd_version3.pt"
...
# IMG_C, IMG_H, IMG_W = images.shape[1], images.shape[2], images.shape[3]
# print(f"Detected dimensions: {IMG_C}x{IMG_H}x{IMG_W}")
...
for epoch in range(1, EPOCHS + 1):
    ...
    # Score calculation (50/50 weighted as per your requirement)
